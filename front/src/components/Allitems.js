...
import { MdFileDownload } from 'react-icons/md'; // Importing MdFileDownload icon
...
const Home = () => {
 ...
 const handleSearch = async () => {
  ...
  const handleDownload = (item) => { // Function to handle download
    try {
                  ...
                  {displayedData.map((item) => (
                    <li key={item._id} className="data-item-section-display-li">
                      ...
                      <div className='cart-home'>
                        <IconButton color="primary" aria-label='Download' onClick={() => handleDownload(item)}>
                          <MdFileDownload size={24} /> {/* Replaced icon with MdFileDownload */}
                        </IconButton>
                        <div className='section-price-free'>
                          {item.price}
                        </div>
                      </div>
                    </li>
